...
def process_single(file_name, folder_path, num_thresholds, func_name, de_configurator, seed=None, images_folder=None):
    try:
        ...
        optimal_cfg = de_configurator.optimize_ga_params(num_thresholds, image, fitness_function, seed)

        ga = GeneticAlgorithm(optimal_cfg, num_thresholds, hist, fitness_function, seed)
