...
def process_images_in_folder(folder_path, threshold_levels, param_settings, output_path):
    ...
    if results:
        ...
        output_file = os.path.join(output_path, "ILSABC_results_corrected.xlsx")
...
if __name__ == "__main__":
    ...
    output_path = r"C:\Users\mzoxo\OneDrive\Documents\standard_test_images\results_corrected_ILSABC"
